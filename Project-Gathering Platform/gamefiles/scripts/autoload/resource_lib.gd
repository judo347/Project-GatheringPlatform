...
#TileMaps
onready var tiles_tileset02 = load("res://gamefiles/tilesets/tileset02.tres")
onready var tiles_tileset03 = load("res://gamefiles/tilesets/tileset03.tres")

#Sound
#onready var sound_music_theme2 = load("res://resources/01/sound/theme02.wav")
